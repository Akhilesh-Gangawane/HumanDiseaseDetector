...
import { Bell, Clock, AlertCircle, Trash2, CheckCircle2, ArrowLeft, Pill, Calendar, FileText } from 'lucide-react';
...
const initialNotifications: Notification[] = [
  { id: 1, type: 'appointment', title: 'Appointment Reminder', message: 'You have an appointment with Dr. Sarah Johnson tomorrow at 10:00 AM.', time: '2 hours ago', read: false },
  { id: 2, type: 'result', title: 'Lab Results Available', message: 'Your Complete Blood Count (CBC) results are now available. Please review them.', time: '5 hours ago', read: false },
  { id: 3, type: 'prescription', title: 'Prescription Refill Due', message: 'Your Lisinopril 10mg prescription is due for refill in 3 days.', time: '1 day ago', read: false },
  { id: 4, type: 'alert', title: 'Abnormal Lab Value', message: 'Your recent blood pressure reading was above normal range. Please consult your doctor.', time: '2 days ago', read: true },
  { id: 5, type: 'general', title: 'Health Tip', message: 'Remember to stay hydrated! Drinking 8 glasses of water daily supports kidney health.', time: '3 days ago', read: true },
  { id: 6, type: 'appointment', title: 'Appointment Confirmed', message: 'Your pathology test booking for March 20 has been confirmed.', time: '4 days ago', read: true },
];
